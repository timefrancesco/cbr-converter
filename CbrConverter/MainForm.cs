...
namespace CbrConverter
{
    public partial class MainForm : Form
    {
        ...
        private void btn_StartStop_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (((chk_cbr2pdf.Checked) || (chk_pdf2cbr.Checked))&&(_fileSelected))
                {
                    ...
                    this.Subscribe(ex);
                    ex.BeginExtraction(chk_cbr2pdf.Checked, chk_pdf2cbr.Checked, chk_ReduceSize.Checked, chk_NbPages.Checked, chk_JoinImages.Checked, chk_NbPages.Checked, false);
                }
            }
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
           ...
           var x =  System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
           Console.WriteLine(x);
           this.Text = "Cbr Converter " + x.ToString();
        }

        private void lbl_about_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("http://www.frapps.net");
        }
